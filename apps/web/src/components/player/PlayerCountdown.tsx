...
export default function PlayerCountdown() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-4 sm:p-8 select-none w-full max-w-3xl mx-auto text-center animate-scale-in relative">
      ...
      {/* Headline */}
      <h1 className="text-3xl sm:text-5xl font-black text-[#122017] tracking-tight mb-1">
        Fique pronto.
      </h1>
      <p className="text-xs sm:text-sm text-[#555E57] font-medium mb-6 sm:mb-8">
        Prepare-se! A próxima rodada começa em instantes. Olhos na pergunta.
      </p>
      ...
      {/* Guidance Subtitle */}
      <p className="text-xs sm:text-sm font-bold text-[#123829] tracking-wider uppercase mt-6 sm:mt-8 flex items-center gap-2">
        <span>Respire.</span>
